...
<head>
    ...
    <script src="${pageContext.request.contextPath}/Static/bootstrap-4.5.0-dist/js/js.cookie.js" type="module"></script>
    <script src="${pageContext.request.contextPath}/Static/bootstrap-4.5.0-dist/js/jquery-3.5.1.js"></script>
<%-- 一定要用这种方式获取目录，不然会找不到路径！在css中  --%>

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.0/dist/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Static/bootstrap-4.5.0-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Static/bootstrap-4.5.0-dist/css/bootstrap.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Static/bootstrap-4.5.0-dist/css/bootstrap-grid.css">
    ...
    <div class="container">
        <div class="row" style="height: 900px">
            ...
            <div class="col-lg-6">
                ...
                <!--            用户选择是否记忆-->
                <div style="margin-bottom: 30px;margin-top: 40px" class="">
                ...
                <div style="margin-top: 20px" class="position-absolute fixed-bottom mx-auto">
                    <nav aria-label="..." >
                        <!--            分页-->
                        <ul class="pagination">
