...
<div style="width: 70%; margin-left: 15%; word-break: break-all" class="alert alert-info" role="alert">
    <p>汉语解释</p>
</div>
<div style="width: 70%; height:300px;margin-left: 15%;word-break: break-all" class="alert alert-success" role="alert">
